...
<div class="form-group">
	...
	<div class="input-group mb-3">
	  <input name="name" class="form-control" aria-describedby="basic-addon" maxlength="100" type="text" id="EmployeeName"/>
	  <div class="input-group-append">
	    <?php echo $this->Form->submit('Search employee', array('class' => 'btn btn-primary')); ?>
	  </div>
	</div>
</div>
...
<div class="d-flex justify-content-between my-3">
	List Employees
	<div>
		<?php echo $this->Html->link('List Employee', array('controller' => 'employees', 'action' => 'index'), array('class' => 'btn btn-success btn-sm')); ?>
	...
	<tbody>
		...
		foreach($lists as $list) { $img = $list['Employee']['pic']; ?>
			<tr>
				...
				<td><img src="<?php echo $this->webroot.'img/emp/'.$img ?>" class="img-thumbnail w-50" ></td>
				<td><?= $list['Employee']['created']; ?></td>
				<td>
